  ...
  return (
    <div className="w-[400px] mb-10">
      ...
      <label
        ...
        className="w-[400px] p-3 border-2 border-solid rounded-lg flex items-center mb-2 hover:border-gray-500"
      >
        <input
          type="radio"
          id={question.id + "a"}
      ...
      <label
        ...
        className="w-[400px] p-3 border-2 border-solid rounded-lg flex items-center hover:border-gray-500"
      >
        <input
          type="radio"
          id={question.id + "b"}
